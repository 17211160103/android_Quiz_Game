...
//    Boolean is_admin = false;
    ...
    String url ;
    private final String TAG = "PlayQuizActivity";
    ...
    private void init() {
        ...
        for (String a : member_array) {
            System.out.println("---"+a);
        }
        roomname = getIntent().getStringExtra("roomname");System.out.println("room name---"+roomname);
        url = getIntent().getStringExtra("url");
        time = getIntent().getIntExtra("time",120);System.out.println("time---"+time);
        is_admin = getIntent().getBooleanExtra("is_admin",false);System.out.println("isAdmin?---"+is_admin);
...
//
    ...
    private void serve_question(){
        ...
        if(question_number<question_array.size()){
            ...
            Toast.makeText(PlayQuiz.this,"win",Toast.LENGTH_LONG);
        }
    }
    ...
    private  void check_answer(int option){
        switch (option)
        {
            ...
            case 1:
                ...
                System.out.println("答案大小="+correct_ans.size()+";选项大小----"+optiona_array.size()+";当前--------"+question_number);
                break;
            case 2:
