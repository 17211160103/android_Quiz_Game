...
import cn.wzu.ccw.game.bean.OtpCode;
import cn.wzu.ccw.game.constant.ModelConstant;
import cn.wzu.ccw.game.constant.NetConstant;
import cn.wzu.ccw.game.databinding.ActivityRegisterBinding;
        ...
        XHttp.post(NetConstant.getRegisterURL())
                ...
                .execute(new SimpleCallBack<Object>() {
                    ...
                    public void onSuccess(Object data) throws Throwable {
                        ...
                        if (editor.commit()) {
                            Intent intentToMain = new Intent(RegisterActivity.this, LoginActivity.class);
