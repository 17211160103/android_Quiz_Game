...
*/
        if (isLogin) {
            startActivity(new Intent(CountDownActivity.this, Home.class));
        } else {
            startActivity(new Intent(CountDownActivity.this, LoginActivity.class));
        }
                ...
                okHttpClient.newCall(request).enqueue(new Callback() {
                    ...
                    public void onResponse(Call call, Response response) throws IOException {
                        ...
                        if (responseStr.contains("200")) {
                            ...
                            JsonObject responseBodyJSONObject = (JsonObject) new JsonParser().parse(responseBodyStr); //string 转化为Json格式
