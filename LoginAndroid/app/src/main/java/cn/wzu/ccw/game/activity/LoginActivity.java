...
import cn.wzu.ccw.game.databinding.ActivityLoginBinding;
import cn.wzu.ccw.game.util.ValidUtils;
import okhttp3.Call;
...
public class LoginActivity extends BaseActivity
    ...
    shared_prefference shared_prefference;
        ...
        XHttp.post(NetConstant.getLoginURL())
                ...
                .execute(new SimpleCallBack<Object>() {
                    ...
                    public void onSuccess(Object obj) throws Throwable {
                        ...
                        shared_prefference=new shared_prefference(LoginActivity.this);
                        shared_prefference.setName(telephone);
                        if (editor.commit()) {
                            Intent it_login_to_main = new Intent(LoginActivity.this, Home.class);
                            it_login_to_main.putExtra("name",telephone);
