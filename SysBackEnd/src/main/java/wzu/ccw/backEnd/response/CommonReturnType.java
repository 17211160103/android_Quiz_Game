package wzu.ccw.backEnd.response;
...
public class CommonReturnType {
    ...
    public static CommonReturnType create(int code,ArrayList<Question> data) {
        return CommonReturnType.create(code, "success", data);
    }
