...
import wzu.ccw.backEnd.controller.viewobject.RegisterVO;
import wzu.ccw.backEnd.controller.viewobject.UserVO;
import wzu.ccw.backEnd.error.BusinessException;
import wzu.ccw.backEnd.error.EmBusinessError;
import wzu.ccw.backEnd.response.CommonReturnType;
import wzu.ccw.backEnd.response.OtpCode;
import wzu.ccw.backEnd.service.UserService;
import wzu.ccw.backEnd.service.model.UserModel;
import wzu.ccw.backEnd.util.CommonUtil;
...
public class UserController extends BaseController {
    ...
    public CommonReturnType register(
        ...
        System.out.println("---------------register-------------01");
        boolean hasRegistered = userService.getUserByTelephone(telephone);
        System.out.println("---------------register-------------02");
        ...
        System.out.println("---------------register-------------03");
